                        ...
                        <div className="col-lg-6">
                            <div className="about__four-right">
                                <div className="about__four-right-title">
                                    ...
                                    <h2>Pioneers of Solar Progress & Excellence
                                    </h2>
                                    <p>Beamsonic Energy stands as a guiding light in the journey toward a sustainable future, driven by the limitless power of the sun. We envision a world where every home and business thrives on clean, renewable solar energy.
                                    </p>
                                </div>
                                <div className="about__four-right-list">
                                    <span><i className="fa-sharp fa-solid fa-circle-check"></i>Business Leadership
                                    </span>
                                    <span><i className="fa-sharp fa-solid fa-circle-check"></i>Award-Winning Excellence</span>
                                </div>
